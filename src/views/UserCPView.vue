...
import UserCPProfile from '../components/usercp/UserCPProfile.vue'
          ...
          <div class="p-5 text-center border-b" :class="isDark ? 'border-gray-800' : 'border-gray-100'">
            <div class="flex justify-center mb-3">
              <UserAvatar
                ...
                :color="authStore.user?.avatar_color || 'bg-purple-500'"
      ...
      <div class="flex-1 min-w-0">
        ...
        >
          ...
          <div v-show="activeSection === 'profile'">
            <UserCPProfile :is-dark="isDark" @message="handleSubMessage" @error="handleSubError" />
          </div>

          <!-- ACCOUNT -->
          <div v-show="activeSection === 'account'">
            <UserCPAccount :is-dark="isDark" @message="handleSubMessage" @error="handleSubError" />
          </div>
          ...
          <div v-show="activeSection === 'cover'">
            <UserCPCover :is-dark="isDark" @message="handleSubMessage" @error="handleSubError" />
          </div>
